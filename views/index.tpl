                  ...
                  <div class="card text-center">
                    ...
                    <div class="card-body">
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner" id="corousel_image" style="overflow: hidden;height:50vh">
                                  {{range $idx,$val := .BreedInfo.Images}}
                                    <div class="carousel-item {{if eq $idx 0}}active{{end}}" style="overflow: hidden;height:50vh">
                                      <img class="d-block w-100" src="{{$val}}" alt="cat-image" style="width:100%;height:100%;" style="object-fit: cover;">
                                    </div>
                                  {{end}}
                                </div>
